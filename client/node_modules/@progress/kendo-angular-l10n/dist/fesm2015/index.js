...
MessageService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: MessageService, factory: function MessageService_Factory(t) { return new (t || MessageService)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MessageService, [{
        type: Injectable
    }], function () { return []; }, { constructor: [], changes: [], notify: [], get: [] });;
...
LocalizationService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: LocalizationService, factory: function LocalizationService_Factory(t) { return new (t || LocalizationService)(ɵngcc0.ɵɵinject(L10N_PREFIX), ɵngcc0.ɵɵinject(MessageService, 8), ɵngcc0.ɵɵinject(RTL, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(LocalizationService, [{
        type: Injectable
                ...
                type: Inject,
                args: [RTL]
            }] }]; }, { constructor: [], prefix: [], messageService: [], _rtl: [], changes: [], dictionary: [], subscription: [], rtl: [], ngOnDestroy: [], get: [], register: [], notifyChanges: [], key: [], defaultValue: [] });;
