...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MessageService, [{
        type: Injectable
    }], function () { return []; }, { changes: [], notify: [], get: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(LocalizationService, [{
        type: Injectable
                ...
                type: Inject,
                args: [RTL]
            }] }]; }, { prefix: [], messageService: [], _rtl: [], changes: [], dictionary: [], subscription: [], rtl: [], ngOnDestroy: [], get: [], register: [], notifyChanges: [], key: [], defaultValue: [] });
