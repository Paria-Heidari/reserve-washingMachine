...
ResizeSensorComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: ResizeSensorComponent, selectors: [["kendo-resize-sensor"]], factory: function ResizeSensorComponent_Factory(t) { return new (t || ResizeSensorComponent)(ɵngcc0.ɵɵdirectiveInject(resize_batch_service_1.ResizeBatchService), ɵngcc0.ɵɵdirectiveInject(core_1.ElementRef), ɵngcc0.ɵɵdirectiveInject(core_1.NgZone)); }, inputs: { rateLimit: "rateLimit" }, outputs: { resize: "resize" }, consts: 0, vars: 0, template: function ResizeSensorComponent_Template(rf, ctx) { }, encapsulation: 2 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ResizeSensorComponent, [{
    ...
    }], function () { return [{ type: resize_batch_service_1.ResizeBatchService }, { type: core_1.ElementRef }, { type: core_1.NgZone }]; }, { rateLimit: [{
            type: Input
        }], resize: [{
            type: Output
