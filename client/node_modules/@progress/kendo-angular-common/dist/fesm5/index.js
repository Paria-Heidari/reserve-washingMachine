...
DraggableDirective.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: DraggableDirective, selectors: [["", "kendoDraggable", ""]], factory: function DraggableDirective_Factory(t) { return new (t || DraggableDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(NgZone)); }, inputs: { enableDrag: "enableDrag" }, outputs: { kendoPress: "kendoPress", kendoDrag: "kendoDrag", kendoRelease: "kendoRelease" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DraggableDirective, [{
        type: Directive,
        args: [{
                selector: '[kendoDraggable]'
            }]
    }], function () { return [{ type: ElementRef }, { type: NgZone }]; }, { element: [], ngZone: [], enableDrag: [{
            type: Input
        }], kendoPress: [{
            type: Output
        }], kendoDrag: [{
            ...
            type: Output
        }], ngOnInit: [], ngOnChanges: [], ngOnDestroy: [], toggleDraggable: [], draggable: [], destroyDraggable: [] });
...
DraggableModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: DraggableModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(DraggableModule, { declarations: function () { return [DraggableDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [DraggableDirective]; } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DraggableModule, [{
        type: NgModule,
        args: [{
...
DraggableModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function DraggableModule_Factory(t) { return new (t || DraggableModule)(); }, imports: [[CommonModule]] });
...
EventsOutsideAngularDirective.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: EventsOutsideAngularDirective, selectors: [["", "kendoEventsOutsideAngular", ""]], factory: function EventsOutsideAngularDirective_Factory(t) { return new (t || EventsOutsideAngularDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(NgZone), ɵngcc0.ɵɵdirectiveInject(Renderer2)); }, inputs: { events: ["kendoEventsOutsideAngular", "events"], scope: "scope" } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(EventsOutsideAngularDirective, [{
        type: Directive,
        args: [{
                selector: '[kendoEventsOutsideAngular]'
            }]
    }], function () { return [{ type: ElementRef }, { type: NgZone }, { type: Renderer2 }]; }, { element: [], ngZone: [], renderer: [], events: [{
            type: Input,
            args: ['kendoEventsOutsideAngular']
        }], ngOnInit: [], subscriptions: [], ngOnDestroy: [], scope: [{
            type: Input
        }] });
...
EventsModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: EventsModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(EventsModule, { declarations: [EventsOutsideAngularDirective], exports: [EventsOutsideAngularDirective] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(EventsModule, [{
        type: NgModule,
        args: [{
...
EventsModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function EventsModule_Factory(t) { return new (t || EventsModule)(); } });
    return EventsModule;
}());
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ResizeBatchService, [{
        type: Injectable
    }], function () { return [{ type: NgZone }]; }, { ngZone: [], scheduled: [], resolvedPromise: [], flush: [], schedule: [], isScheduled: [], cancel: [], ngOnDestroy: [], unsubscribe: [], subscription: [] });
...
ResizeSensorModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: ResizeSensorModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(ResizeSensorModule, { declarations: [ResizeSensorComponent], exports: [ResizeSensorComponent] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ResizeSensorModule, [{
        type: NgModule,
        args: [{
...
ResizeSensorModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function ResizeSensorModule_Factory(t) { return new (t || ResizeSensorModule)(); }, providers: [ResizeBatchService] });
