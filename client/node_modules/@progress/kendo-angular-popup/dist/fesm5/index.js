...
import { Injectable, InjectionToken, Inject, Optional, NgZone, isDevMode, EventEmitter, Input, ElementRef, Output, ViewChild, Component, Renderer2, TemplateRef, ApplicationRef, ComponentFactoryResolver, Injector, NgModule } from '@angular/core';
...
const _c0 = ["container"];
const _c1 = [1, "k-popup", 3, "ngClass"];
const _c2 = ["container", ""];
const _c3 = [3, "ngTemplateOutlet", "ngIf"];
const _c4 = [3, "rateLimit", "resize"];
 ...
 * @hidden
 */
var hasRelativeStackingContext = memoize(ɵ3);
/**
 * @hidden
 */
...
DOMService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: DOMService, factory: function DOMService_Factory(t) { return new (t || DOMService)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DOMService, [{
        type: Injectable
    }], function () { return []; }, { addOffset: [], addScroll: [], align: [], boundingOffset: [], getFontStyles: [], getWindow: [], hasOffsetParent: [], offset: [], offsetAtPoint: [], nativeElement: [], position: [], removeScroll: [], restrictToView: [], scrollPosition: [], scrollableParents: [], stackingElementOffset: [], stackingElementScroll: [], getRelativeContextElement: [], useRelativePosition: [], windowViewPort: [], zIndex: [], zoomLevel: [], isZoomed: [] });
    return DOMService;
}());
...
var AlignService = /** @class */ (function () {
    ...
    AlignService = __decorate([
        __param(1, Inject(SCALE)), __param(1, Optional()),
        __metadata("design:paramtypes", [DOMService, Number])
    ], AlignService);
AlignService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AlignService, factory: function AlignService_Factory(t) { return new (t || AlignService)(ɵngcc0.ɵɵinject(DOMService), ɵngcc0.ɵɵinject(SCALE, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AlignService, [{
        type: Injectable
                ...
                type: Optional
            }] }]; }, { _dom: [], scale: [], alignElement: [], absoluteRect: [], elementScrollPosition: [], relativeRect: [] });
    return AlignService;
}());
...
ResizeService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ResizeService, factory: function ResizeService_Factory(t) { return new (t || ResizeService)(ɵngcc0.ɵɵinject(DOMService), ɵngcc0.ɵɵinject(NgZone)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ResizeService, [{
        type: Injectable
    }], function () { return [{ type: DOMService }, { type: NgZone }]; }, { _dom: [], _zone: [], subscribe: [], unsubscribe: [], isUnsubscribed: [] });
...
ScrollableService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ScrollableService, factory: function ScrollableService_Factory(t) { return new (t || ScrollableService)(ɵngcc0.ɵɵinject(DOMService), ɵngcc0.ɵɵinject(NgZone)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollableService, [{
        type: Injectable
    }], function () { return [{ type: DOMService }, { type: NgZone }]; }, { _dom: [], _zone: [], forElement: [], element: [], subscribe: [], unsubscribe: [], isVisible: [] });
...
AnimationService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AnimationService, factory: function AnimationService_Factory(t) { return new (t || AnimationService)(ɵngcc0.ɵɵinject(AnimationBuilder)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AnimationService, [{
        type: Injectable
    }], function () { return [{ type: AnimationBuilder }]; }, { animationBuilder: [], start: [], end: [], play: [], flip: [], ngOnDestroy: [], playStates: [], player: [], getDirection: [], stopPlayer: [] });
...
PopupComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: PopupComponent, selectors: [["kendo-popup"]], factory: function PopupComponent_Factory(t) { return new (t || PopupComponent)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(AlignService), ɵngcc0.ɵɵdirectiveInject(DOMService), ɵngcc0.ɵɵdirectiveInject(PositionService), ɵngcc0.ɵɵdirectiveInject(ResizeService), ɵngcc0.ɵɵdirectiveInject(ScrollableService), ɵngcc0.ɵɵdirectiveInject(AnimationService), ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(NgZone)); }, viewQuery: function PopupComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(_c0, true);
        ɵngcc0.ɵɵstaticViewQuery(ResizeSensorComponent, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.contentContainer = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.resizeSensor = _t.first);
    } }, inputs: { animate: "animate", anchorAlign: "anchorAlign", collision: "collision", popupAlign: "popupAlign", copyAnchorStyles: "copyAnchorStyles", positionMode: "positionMode", offset: "offset", anchor: "anchor", popupClass: "popupClass", margin: "margin" }, outputs: { anchorViewportLeave: "anchorViewportLeave", close: "close", open: "open", positionChange: "positionChange" }, exportAs: ["kendo-popup"], features: [ɵngcc0.ɵɵProvidersFeature([AlignService, AnimationService, DOMService, PositionService, ResizeService, ScrollableService]), ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c5, consts: 5, vars: 4, template: function PopupComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelementStart(0, "div", _c1, _c2);
        ɵngcc0.ɵɵprojection(2);
        ɵngcc0.ɵɵtemplate(3, PopupComponent_ng_template_3_Template, 0, 0, "ng-template", _c3);
        ɵngcc0.ɵɵelementStart(4, "kendo-resize-sensor", _c4);
        ɵngcc0.ɵɵlistener("resize", function PopupComponent_Template_kendo_resize_sensor_resize_4_listener($event) { return ctx.onResize(); });
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopupComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ElementRef }, { type: AlignService }, { type: DOMService }, { type: PositionService }, { type: ResizeService }, { type: ScrollableService }, { type: AnimationService }, { type: Renderer2 }, { type: NgZone }]; }, { container: [], _alignService: [], domService: [], _positionService: [], _resizeService: [], _scrollableService: [], animationService: [], _renderer: [], _zone: [], animate: [{
            type: Input
        }], anchorAlign: [{
            type: Input
        }], collision: [{
            ...
            type: Output
        }], resolvedPromise: [], initialCheck: [], ngOnInit: [], reposition: [], animationSubscriptions: [], currentOffset: [], ngOnChanges: [], ngAfterViewInit: [], ngAfterViewChecked: [], ngOnDestroy: [], onResize: [], onAnimationStart: [], onAnimationEnd: [], setZIndex: [], position: [], onScroll: [], copyFontStyles: [], updateFixedClass: [], setContainerStyle: [], unsubscribeReposition: [], anchor: [{
            type: Input
        }], popupClass: [{
            type: Input
        }], margin: [{
...
var PopupService = /** @class */ (function () {
    ...
    PopupService = __decorate([
        __param(3, Inject(POPUP_CONTAINER)), __param(3, Optional()),
        __metadata("design:paramtypes", [ApplicationRef,
            ComponentFactoryResolver,
            Injector,
            ElementRef])
    ], PopupService);
PopupService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: PopupService, factory: function PopupService_Factory(t) { return new (t || PopupService)(ɵngcc0.ɵɵinject(ApplicationRef), ɵngcc0.ɵɵinject(ComponentFactoryResolver), ɵngcc0.ɵɵinject(Injector), ɵngcc0.ɵɵinject(POPUP_CONTAINER, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopupService, [{
        type: Injectable
                ...
                type: Optional
            }] }]; }, { applicationRef: [], componentFactoryResolver: [], injector: [], container: [], rootViewContainer: [], rootViewContainerNode: [], open: [], appendPopup: [], getComponentRootNode: [], getComponentFactory: [], createComponent: [], projectComponentInputs: [], contentFrom: [] });
    return PopupService;
}());
...
PopupModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: PopupModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(PopupModule, { declarations: function () { return [PopupComponent]; }, imports: function () { return [CommonModule, ResizeSensorModule]; }, exports: function () { return [PopupComponent]; } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopupModule, [{
        type: NgModule,
        args: [{
...
PopupModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function PopupModule_Factory(t) { return new (t || PopupModule)(); }, providers: [PopupService], imports: [[CommonModule, ResizeSensorModule]] });
    return PopupModule;
}());
