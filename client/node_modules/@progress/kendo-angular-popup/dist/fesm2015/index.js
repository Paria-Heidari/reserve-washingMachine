...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AlignService, [{
        type: Injectable
                ...
                type: Optional
            }] }]; }, { constructor: [], _dom: [], scale: [], alignElement: [], absoluteRect: [], elementScrollPosition: [], relativeRect: [] });;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PositionService, [{
        type: Injectable
                ...
                type: Optional
            }] }]; }, { constructor: [], _dom: [], scale: [], positionElement: [] });;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ResizeService, [{
        type: Injectable
    }], function () { return [{ type: DOMService }, { type: NgZone }]; }, { constructor: [], _dom: [], _zone: [], subscribe: [], subscription: [], unsubscribe: [], isUnsubscribed: [] });;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollableService, [{
        type: Injectable
    }], function () { return [{ type: DOMService }, { type: NgZone }]; }, { constructor: [], _dom: [], _zone: [], forElement: [], element: [], subscribe: [], subscription: [], unsubscribe: [], isVisible: [] });;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AnimationService, [{
        type: Injectable
    }], function () { return [{ type: AnimationBuilder }]; }, { constructor: [], animationBuilder: [], start: [], end: [], play: [], flip: [], ngOnDestroy: [], playStates: [], player: [], getDirection: [], stopPlayer: [] });;
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopupComponent, [{
     ...
     `
    ...
    }], function () { return [{ type: ElementRef }, { type: AlignService }, { type: DOMService }, { type: PositionService }, { type: ResizeService }, { type: ScrollableService }, { type: AnimationService }, { type: Renderer2 }, { type: NgZone }]; }, { constructor: [], container: [], _alignService: [], domService: [], _positionService: [], _resizeService: [], _scrollableService: [], animationService: [], _renderer: [], _zone: [], animate: [{
            type: Input
        }], anchorAlign: [{
            type: Input
        }], collision: [{
            ...
            type: Output
        }], resolvedPromise: [], initialCheck: [], ngOnInit: [], reposition: [], animationSubscriptions: [], currentOffset: [], currentOffset: [], ngOnChanges: [], ngAfterViewInit: [], ngAfterViewChecked: [], repositionSubscription: [], ngOnDestroy: [], onResize: [], onAnimationStart: [], onAnimationEnd: [], _currentOffset: [], setZIndex: [], position: [], onScroll: [], copyFontStyles: [], updateFixedClass: [], setContainerStyle: [], unsubscribeReposition: [], anchor: [{
            type: Input
        }], popupClass: [{
            type: Input
        }], margin: [{
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopupService, [{
        type: Injectable
                ...
                type: Optional
            }] }]; }, { constructor: [], applicationRef: [], componentFactoryResolver: [], injector: [], container: [], rootViewContainer: [], rootViewContainerNode: [], open: [], appendPopup: [], getComponentRootNode: [], getComponentFactory: [], createComponent: [], projectComponentInputs: [], contentFrom: [] });;
