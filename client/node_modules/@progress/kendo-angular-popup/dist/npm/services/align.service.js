...
AlignService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AlignService, factory: function AlignService_Factory(t) { return new (t || AlignService)(ɵngcc0.ɵɵinject(dom_service_1.DOMService), ɵngcc0.ɵɵinject(scale_1.SCALE, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AlignService, [{
        type: Injectable
    }], function () { return [{ type: dom_service_1.DOMService }, { type: Number, decorators: [{
                type: Inject,
                args: [scale_1.SCALE]
            }, {
                type: Optional
