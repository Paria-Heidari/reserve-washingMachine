...
ScrollableService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ScrollableService, factory: function ScrollableService_Factory(t) { return new (t || ScrollableService)(ɵngcc0.ɵɵinject(dom_service_1.DOMService), ɵngcc0.ɵɵinject(core_1.NgZone)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollableService, [{
        type: Injectable
    }], function () { return [{ type: dom_service_1.DOMService }, { type: core_1.NgZone }]; }, { _dom: [], _zone: [], forElement: [], element: [], subscribe: [], unsubscribe: [], isVisible: [] });
    return ScrollableService;
}());
exports.ScrollableService = ScrollableService;

//# sourceMappingURL=scrollable.service.js.map