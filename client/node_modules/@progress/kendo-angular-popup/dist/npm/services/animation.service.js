...
var AnimationService = /** @class */ (function () {
    ...
    AnimationService = tslib_1.__decorate([
        tslib_1.__metadata("design:paramtypes", [animations_1.AnimationBuilder])
    ], AnimationService);
AnimationService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AnimationService, factory: function AnimationService_Factory(t) { return new (t || AnimationService)(ɵngcc0.ɵɵinject(animations_1.AnimationBuilder)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AnimationService, [{
        type: Injectable
    }], function () { return [{ type: animations_1.AnimationBuilder }]; }, { animationBuilder: [], start: [], end: [], play: [], flip: [], ngOnDestroy: [], playStates: [], player: [], getDirection: [], stopPlayer: [] });
