...
var handleExpandCollapseGroupsService = function (service, expandEmitter, collapseEmitter, map) { return (service.changes.pipe(filter(function (_a) {
    var group = _a.group;
...
var handleExpandCollapseDetailsService = function (service, expandEmitter, collapseEmitter, map) { return (service.changes.pipe(filter(function (_a) {
