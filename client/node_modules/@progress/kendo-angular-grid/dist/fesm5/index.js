...
import { InjectionToken, HostBinding, Input, Component, Injectable, EventEmitter, Optional, Inject, Directive, SkipSelf, ElementRef, Renderer2, NgZone, ChangeDetectorRef, TemplateRef, ContentChildren, QueryList, ContentChild, forwardRef, Host, Output, isDevMode, SecurityContext, ViewChild, ViewChildren, ViewEncapsulation, Self, ViewContainerRef, Pipe, NgModule, ComponentFactoryResolver, HostListener, ChangeDetectionStrategy } from '@angular/core';
 ...
 * @hidden
 */
var nodesToArray = function (nodes) { return [].slice.call(nodes); };
/**
 * @hidden
 */
...
var FocusRoot = /** @class */ (function () {
    ...
    FocusRoot = __decorate([
        Injectable(),
        __param(0, Optional()), __param(0, Inject(FOCUS_ROOT_ACTIVE)),
 ...
 * @hidden
 */
var findLastElement = function (node, predicate, matchSelf) {
    if (matchSelf === void 0) { matchSelf = true; }
    var last = null;
    findElement(node, function (node) {
        if (predicate(node)) {
            last = node;
        }
        return false;
 ...
 * @hidden
 */
var findLastFocusableChild = function (element, checkVisibility) {
    if (checkVisibility === void 0) { checkVisibility = true; }
    return findLastElement(element, function (node) { return isFocusableWithTabKey(node, checkVisibility); }, false);
};
/**
 * @hidden
 */
 ...
 * @hidden
 */
var getGroupRowArgs = function (groupItem) {
...
var NavigationService = /** @class */ (function () {
    ...
    NavigationService.prototype.unregisterRow = function (index, row) {
        ...
        var lastRow = this.model.lastRow;
        if (lastRow && this.mode === 0 /* Standby */) {
            var maxIndex = (this.needsViewport() && this.viewport) ? this.viewport.lastItemIndex : lastRow.index;
            ...
            case Keys.F2:
                ...
                if (groupItem_1) {
                    this.zone.run(function () {
                        return _this.groupsService.toggleRow(groupItem_1);
                    });
                }
...
var ColumnBase$1 = /** @class */ (function () {
     ...
     * @hidden
     */
    function ColumnBase$$1(parent, idService) {
        this.parent = parent;
        /**
         * @hidden
         */
...
var ColumnComponent = /** @class */ (function (_super) {
    ...
    function ColumnComponent(parent, idService) {
    ...
    ColumnComponent = ColumnComponent_1 = __decorate([
        ...
        __param(0, SkipSelf()), __param(0, Host()), __param(0, Optional()), __param(1, Optional()),
...
var SpanColumnComponent = /** @class */ (function (_super) {
    ...
    function SpanColumnComponent(parent, idService) {
        var _this = _super.call(this, parent, idService) || this;
        /*
         * @hidden
         */
...
var ColumnGroupComponent = /** @class */ (function (_super) {
    ...
    function ColumnGroupComponent(parent, idService) {
        var _this = _super.call(this, parent, idService) || this;
        _this.parent = parent;
        /**
         * @hidden
...
var getIterator$1 = function (data, _a) {
    var footers = _a.footers, level = _a.level, dataIndex = _a.dataIndex, parentGroupIndex = _a.parentGroupIndex, groupIndex = _a.groupIndex, parentGroup = _a.parentGroup;
    var first = data[0];
    if (isPresent(first) && isGroupItem(first)) {
...
var ItemIterator = /** @class */ (function (_super) {
    ...
    function ItemIterator(arr, dataIndex, groupIndex, group) {
...
var GroupIterator = /** @class */ (function () {
    function GroupIterator(arr, outputFooters, level, dataIndex, parentIndex, groupIndex, parentGroup) {
        if (outputFooters === void 0) { outputFooters = false; }
        if (level === void 0) { level = 0; }
        if (dataIndex === void 0) { dataIndex = 0; }
        if (parentIndex === void 0) { parentIndex = ""; }
        if (groupIndex === void 0) { groupIndex = 0; }
        if (parentGroup === void 0) { parentGroup = undefined; }
        this.arr = arr;
...
var ColumnList = /** @class */ (function () {
    ...
    ColumnList.prototype.totalColumnLevels = function () {
        var totalLevels = 0;
 ...
 */
var ColumnStickyChangeEvent = /** @class */ (function () {
    /**
     * @hidden
     */
    function ColumnStickyChangeEvent(columns) {
        this.columns = columns;
    }
    return ColumnStickyChangeEvent;
}());
...
var CellLoadingTemplateDirective = /** @class */ (function () {
    ...
    CellLoadingTemplateDirective = __decorate([
        Directive({
...
var handleExpandCollapseGroupsService = function (service, expandEmitter, collapseEmitter, map$$1) { return (service.changes.pipe(filter(function (_a) {
    var group = _a.group;
    return isPresent(group);
}))
    .subscribe(function (x) { return x.expand ? expandEmitter.emit(map$$1(x)) : collapseEmitter.emit(map$$1(x)); })); };
var handleExpandCollapseDetailsService = function (service, expandEmitter, collapseEmitter, map$$1) { return (service.changes.pipe(filter(function (_a) {
...
var GridComponent = /** @class */ (function () {
    function GridComponent(supportService, selectionService, cellSelectionService, wrapper, groupInfoService, groupsService, changeNotification, detailsService, editService, filterService, pdfService, responsiveService, renderer, excelService, ngZone, scrollSyncService, domEvents, columnResizingService, changeDetectorRef, columnReorderService, columnInfoService, navigationService, sortService, scrollRequestService, localization) {
        ...
        this.columnStickyChangeSubscription = this.columnInfoService.stickyChange.subscribe(function (changed) {
            _this.columnStickyChange.emit(new ColumnStickyChangeEvent(changed));
        });
        this.groupExpandCollapseSubscription = handleExpandCollapseGroupsService(groupsService, this.groupExpand, this.groupCollapse, function (_a) {
            var group = _a.group, groupIndex = _a.groupIndex, parentGroup = _a.parentGroup;
            return ({ group: group, groupIndex: groupIndex, parentGroup: parentGroup });
        });
        this.detailsServiceSubscription = handleExpandCollapseDetailsService(detailsService, this.detailExpand, this.detailCollapse, function (args) { return args; });
    ...
    Object.defineProperty(GridComponent.prototype, "showTopPager", {
        /**
         * @hidden
         */
        get: function () {
            var position = this.pageable.position;
            return !this.isVirtual && this.pageable !== false && ['top', 'both'].indexOf(position) > -1;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(GridComponent.prototype, "showBottomPager", {
        /**
         * @hidden
         */
        get: function () {
    ...
    Object.defineProperty(GridComponent.prototype, "hasPager", {
        /**
         * @hidden
         */
        get: function () {
    ...
    Object.defineProperty(GridComponent.prototype, "rowSticky", {
        get: function () {
    ...
    Object.defineProperty(GridComponent.prototype, "loadingTemplate", {
        get: function () {
    ...
    Object.defineProperty(GridComponent.prototype, "headerPadding", {
        get: function () {
            ...
            var padding = Math.max(0, this.scrollbarWidth) + 'px';
    ...
    Object.defineProperty(GridComponent.prototype, "stickyColumns", {
        get: function () {
            return this.columns.filter(function (column) { return column.sticky; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(GridComponent.prototype, "ariaLabel", {
        /**
         * @hidden
         */
        get: function () {
    ...
    GridComponent.prototype.reorderColumn = function (source, destIndex, options) {
        ...
        var columnsForLevel = sortColumns(this.allColumnsForLevel(source.level));
    ...
    Object.defineProperty(GridComponent.prototype, "isGroupExpanded", {
        get: function () {
    ...
    GridComponent.prototype.reorder = function (_a) {
        ...
        this.ngZone.run(function () {
            var columnsForLevel = sortColumns(_this.allColumnsForLevel(source.level));
            ...
            _this.updateColumnIndices({ columnsForLevel: columnsForLevel, source: source, target: target, before: before });
    ...
    GridComponent.prototype.updateColumnIndices = function (_a) {
        var columnsForLevel = _a.columnsForLevel, source = _a.source, target = _a.target, before = _a.before;
        var expandedColumns = expandColumnsWithSpan(columnsForLevel);
    ...
    GridComponent.prototype.updateIndicesForLevel = function (level) {
        var colsForParentLevel = this.allColumnsForLevel(level - 1);
        var colsForLevel = [];
    ...
    GridComponent.prototype.allColumnsForLevel = function (level) {
        return this.columnList.toArray().filter(function (column) { return column.level === level; });
    };
    ...
    GridComponent.prototype.verifySettings = function () {
        if (isDevMode()) {
            ...
            var stickyColumns = this.stickyColumns.length || (this.columnMenu && this.columnMenu.stick);
            ...
            if (stickyColumns && expandColumns(this.columnList.toArray()).filter(function (column) { return !column.width && !isColumnGroupComponent(column); }).length) {
    ...
    GridComponent.prototype.toggleGroupRowLegacy = function (index, expand) {
        var hasCallback = typeof this.isGroupExpanded === 'function';
        if (isDevMode() && hasCallback) {
        ...
        if (this.groupsService.isExpanded({ groupIndex: index }) !== expand) {
            this.groupsService.toggleRow({ index: index });
        }
    };
...
var ListComponent = /** @class */ (function () {
    function ListComponent(scrollerFactory, detailsService, changeNotification, suspendService, groupsService, ngZone, renderer, scrollSyncService, resizeService, editService, supportService, navigationService, scrollRequestService, localization, columnResizingService, changeDetector, pdfService, columnInfo) {
        ...
        this.subscriptions.add(scrollRequestService.requests.subscribe(function (x) { return _this.scrollTo(x); }));
    }
...
var ExpandGroupDirective = /** @class */ (function () {
    function ExpandGroupDirective(grid) {
        ...
        this.subscriptions.add(merge(this.grid.groupExpand.pipe(map(function (e) { return (__assign({ expand: true }, e)); })), this.grid.groupCollapse.pipe(map(function (e) { return (__assign({ expand: false }, e)); }))).subscribe(this.toggleState.bind(this)));
    }
    ...
    ExpandGroupDirective = __decorate([
        Directive({
...
var FilterRowComponent = /** @class */ (function () {
    ...
    FilterRowComponent.prototype.addStickyStyles = function (column) {
        ...
        return __assign({}, sticky, column.filterStyle);
    };
...
var NumericFilterCellComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(NumericFilterCellComponent.prototype, "columnLabel", {
        /**
         * @hidden
         */
        get: function () {
...
var FilterInputDirective = /** @class */ (function () {
    ...
    FilterInputDirective.prototype.addAriaAttributes = function () {
        var ariaValue = this.columnLabel;
        if (this.kendoInput && this.kendoInput.focusableId && isDocumentAvailable()) {
            var focusableElement = this.element.nativeElement.querySelector("#" + this.kendoInput.focusableId);
...
var StringFilterCellComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(StringFilterCellComponent.prototype, "columnLabel", {
        /**
         * @hidden
         */
        get: function () {
...
var PagerInputDirective = /** @class */ (function () {
    ...
    PagerInputDirective = __decorate([
        Directive({ selector: '[kendoGridPagerInput]' }),
        __metadata("design:paramtypes", [NumericTextBoxComponent,
            Renderer2])
    ], PagerInputDirective);
...
var PagerDropDownListDirective = /** @class */ (function () {
    function PagerDropDownListDirective(host) {
        ...
        this.keydownHandler = function (e) {
            if (e.keyCode === Keys.Escape && _this.host.isOpen) {
                e.stopPropagation();
    ...
    PagerDropDownListDirective = __decorate([
        Directive({ selector: '[kendoGridPagerDropDown]' }),
        __metadata("design:paramtypes", [DropDownListComponent])
...
var PagerComponent = /** @class */ (function () {
    ...
    PagerComponent = __decorate([
        ...
        __param(6, Optional()), __param(6, Inject(CELL_CONTEXT)),
...
var PagerNextButtonsComponent = /** @class */ (function (_super) {
    ...
    function PagerNextButtonsComponent(localization, pagerContext, cd, navigationService) {
        var _this = _super.call(this, localization, pagerContext, cd) || this;
        _this.navigationService = navigationService;
        return _this;
    }
...
var PagerInputComponent = /** @class */ (function (_super) {
    ...
    function PagerInputComponent(localization, pagerContext, zone, navigationService, cd) {
        var _this = _super.call(this, localization, pagerContext, cd) || this;
        _this.pagerContext = pagerContext;
        _this.zone = zone;
        _this.navigationService = navigationService;
...
var PagerPageSizesComponent = /** @class */ (function (_super) {
    ...
    function PagerPageSizesComponent(localization, cd, pagerContext, navigationService) {
        var _this = _super.call(this, localization, pagerContext, cd) || this;
        _this.pagerContext = pagerContext;
        _this.navigationService = navigationService;
        _this._pageSizes = [];
...
var GroupHeaderComponent = /** @class */ (function () {
    function GroupHeaderComponent(groupsService, groupInfoService, localization) {
        this.groupsService = groupsService;
        this.groupInfoService = groupInfoService;
        this.localization = localization;
    ...
    Object.defineProperty(GroupHeaderComponent.prototype, "groupButtonTitle", {
        get: function () {
            var messageKey = this.isExpanded ? 'groupCollapse' : 'groupExpand';
 ...
 * @hidden
 */
var hasStick = function (settings, column) {
    return settings.stick && column.stickable && !(column.parent && !column.parent.isSpanColumn);
};
/**
 * @hidden
 */
var hasPosition = function (settings, column) {
    return settings.setColumnPosition && (column.stickable || column.lockable) && !(column.parent && !column.parent.isSpanColumn);
};
/**
 * @hidden
 */
...
var ColumnMenuService = /** @class */ (function () {
     ...
     * @hidden
     */
    function ColumnMenuService(menuTabbingService) {
        /**
         * @hidden
         */
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(popupService, hint, cue, reorderService, idService, sortService, localization, columnInfoService, cd) {
        this.popupService = popupService;
        this.hint = hint;
        this.cue = cue;
    ...
    HeaderComponent.prototype.onHeaderKeydown = function (column, args) {
        if (args.keyCode === Keys.ArrowDown && args.altKey && this.showFilterMenu) {
            ...
            var filterMenu = this.filterMenus.find(function (fm) { return fm.column === column; });
        ...
        if (args.keyCode === Keys.ArrowDown && args.altKey && this.showColumnMenu(column)) {
            args.preventDefault();
            args.stopImmediatePropagation();
            var columnMenu = this.columnMenus.find(function (cm) { return cm.column === column; });
    ...
    Object.defineProperty(HeaderComponent.prototype, "selectAllCheckboxLabel", {
        get: function () {
    ...
    HeaderComponent.prototype.addStickyStyles = function (column) {
        var stickyStyles = this.columnInfoService.stickyColumnsStyles(column);
        return __assign({}, column.style, stickyStyles);
    };
...
var DateFilterMenuComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DateFilterMenuComponent.prototype, "filterMenuDropDownLabel", {
        get: function () {
            var localizationMsg = this.localization.get('filterMenuLogicDropDownLabel') || '';
            var columnName = this.column ? this.column.title || this.column.field : '';
            return replaceMessagePlaceholder(localizationMsg, 'columnName', columnName);
...
var BooleanFilterRadioButtonDirective = /** @class */ (function () {
    ...
    BooleanFilterRadioButtonDirective = __decorate([
        Directive({ selector: '[kendoFilterMenuRadioButton]' }),
        __metadata("design:paramtypes", [ElementRef,
            Renderer2])
...
var FilterMenuDropDownListDirective = /** @class */ (function () {
    ...
    FilterMenuDropDownListDirective = __decorate([
        Directive({ selector: '[kendoFilterMenuDropDown]' }),
        __metadata("design:paramtypes", [DropDownListComponent])
...
var ColumnMenuChooserComponent = /** @class */ (function (_super) {
    ...
    function ColumnMenuChooserComponent(localization, columnInfoService, changeDetector, hostElement) {
        var _this = _super.call(this) || this;
        _this.localization = localization;
     ...
     * @hidden
     */
    ColumnMenuChooserComponent.prototype.onCollapse = function () {
        this.expanded = false;
        if (this.isLast) {
     ...
     * @hidden
     */
    ColumnMenuChooserComponent.prototype.onExpand = function () {
        this.expanded = true;
        this.expand.emit();
    };
    __decorate([
...
var ColumnMenuSortComponent = /** @class */ (function (_super) {
    ...
    function ColumnMenuSortComponent(localization, sortService, renderer) {
        var _this = _super.call(this) || this;
        _this.localization = localization;
...
var ColumnMenuPositionComponent = /** @class */ (function (_super) {
    __extends(ColumnMenuPositionComponent, _super);
    ...
    ColumnMenuPositionComponent = __decorate([
        Component({
...
var ColumnMenuItemDirective = /** @class */ (function () {
    ...
    ColumnMenuItemDirective = __decorate([
...
var ColumnMenuContainerComponent = /** @class */ (function () {
    ...
    ColumnMenuContainerComponent.prototype.ngAfterContentInit = function () {
        ...
        this.ngZone.onStable.pipe(take(1)).subscribe(function () { return _this.service.menuTabbingService.firstFocusable.focus(); });
    };
    __decorate([
        ContentChildren(ColumnMenuItemDirective, { descendants: true }),
        __metadata("design:type", QueryList)
    ], ColumnMenuContainerComponent.prototype, "columnMenuItems", void 0);
    ColumnMenuContainerComponent = __decorate([
        Component({
            selector: 'kendo-grid-columnmenu-container',
            template: "\n        <ng-content></ng-content>\n    "
        }),
        __metadata("design:paramtypes", [ColumnMenuService,
            NgZone])
...
var ColumnMenuStickComponent = /** @class */ (function (_super) {
    __extends(ColumnMenuStickComponent, _super);
    ...
    ColumnMenuStickComponent = __decorate([
        Component({
...
var CheckboxColumnComponent = /** @class */ (function (_super) {
    ...
    function CheckboxColumnComponent(parent, idService) {
        var _this = _super.call(this, parent, idService) || this;
        _this.parent = parent;
        /*
         * @hidden
...
var TableBodyComponent = /** @class */ (function () {
    ...
    TableBodyComponent.prototype.isFooterItemInExpandedGroup = function (item) {
        var footerItem = { data: item.data, index: item.groupIndex, parentGroup: item.group.parentGroup };
        return this.isInExpandedGroup(footerItem);
    };
    TableBodyComponent.prototype.isDataItemInExpandedGroup = function (item) {
        var dataItem = { data: item.group.data, index: item.groupIndex, parentGroup: item.group.parentGroup };
    ...
    TableBodyComponent.prototype.ngAfterViewChecked = function () {
        if (this.rowSticky) {
    ...
    TableBodyComponent.prototype.addStickyColumnStyles = function (column) {
        var stickyStyles = this.columnInfoService.stickyColumnsStyles(column);
        return __assign({}, column.style, stickyStyles);
    };
    TableBodyComponent.prototype.resizeHandler = function () {
        this.applyStickyRowsStyling();
    };
    ...
    TableBodyComponent.prototype.applyStickyRowsStyling = function () {
        var _this = this;
        var stickyRows = nodesToArray(this.element.nativeElement.querySelectorAll('.k-grid-row-sticky'));
        var length = stickyRows.length;
        if (length) {
            var accumulatedHeight_1 = 0;
            var stickyRowsOffsets_1 = [];
            stickyRows.forEach(function (row) {
                var rowHeight = row.getBoundingClientRect().height;
                stickyRowsOffsets_1.push({ accumulatedHeight: accumulatedHeight_1, rowHeight: rowHeight });
                accumulatedHeight_1 += rowHeight;
            });
            stickyRows.forEach(function (row, index) {
                _this.renderer.setStyle(row, 'top', stickyRowsOffsets_1[index].accumulatedHeight + "px");
                _this.renderer.setStyle(row, 'bottom', accumulatedHeight_1 - stickyRowsOffsets_1[index].accumulatedHeight - stickyRowsOffsets_1[index].rowHeight + "px");
            });
        }
    };
    __decorate([
...
var CellComponent = /** @class */ (function () {
    ...
    CellComponent = __decorate([
        ...
        __param(3, Optional()), __param(3, Inject(CELL_CONTEXT)),
...
var FooterComponent = /** @class */ (function () {
    function FooterComponent(columnInfoService) {
        this.columnInfoService = columnInfoService;
        this.columns = [];
        this.groups = [];
        this.lockedColumnsCount = 0;
    ...
    FooterComponent.prototype.addStickyStyles = function (column) {
        var stickyStyles = this.columnInfoService.stickyColumnsStyles(column);
        return __assign({}, column.style, stickyStyles);
    };
    __decorate([
    ...
    FooterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ColumnInfoService])
    ], FooterComponent);
...
var GroupBindingDirective = /** @class */ (function (_super) {
    ...
    GroupBindingDirective.prototype.ngAfterContentInit = function () {
