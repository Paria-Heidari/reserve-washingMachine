...
var TableBodyComponent = /** @class */ (function () {
    ...
    TableBodyComponent.prototype.ngOnChanges = function (changes) {
        if (utils_2.isChanged('columns', changes, false)) {
    ...
    TableBodyComponent.prototype.logicalColIndex = function (column) {
        if (!utils_2.isPresent(column.leafIndex)) {
            return -1;
        }
    ...
    TableBodyComponent.prototype.addStickyColumnStyles = function (column) {
        ...
        return tslib_1.__assign({}, column.style, stickyStyles);
    };
    ...
    Object.defineProperty(TableBodyComponent.prototype, "hasDetailTemplate", {
        get: function () {
            return utils_2.isPresent(this.detailTemplate);
        },
        enumerable: true,
        configurable: true
    });
    ...
    TableBodyComponent.prototype.applyStickyRowsStyling = function () {
        var _this = this;
        var stickyRows = utils_1.nodesToArray(this.element.nativeElement.querySelectorAll('.k-grid-row-sticky'));
