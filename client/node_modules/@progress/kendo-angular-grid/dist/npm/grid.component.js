...
var column_sticky_change_event_1 = require("./column-menu/column-sticky-change-event");
var cell_loading_template_directive_1 = require("./rendering/cell-loading.template.directive");
...
exports.ɵ1 = ɵ1;
var handleExpandCollapseGroupsService = function (service, expandEmitter, collapseEmitter, map) { return (service.changes.pipe(operators_1.filter(function (_a) {
    var group = _a.group;
    return utils_1.isPresent(group);
}))
    .subscribe(function (x) { return x.expand ? expandEmitter.emit(map(x)) : collapseEmitter.emit(map(x)); })); };
var ɵ2 = handleExpandCollapseGroupsService;
exports.ɵ2 = ɵ2;
var handleExpandCollapseDetailsService = function (service, expandEmitter, collapseEmitter, map) { return (service.changes.pipe(operators_1.filter(function (_a) {
    var dataItem = _a.dataItem;
    return utils_1.isPresent(dataItem);
}))
    .subscribe(function (x) { return x.expand ? expandEmitter.emit(map(x)) : collapseEmitter.emit(map(x)); })); };
var ɵ3 = handleExpandCollapseDetailsService;
exports.ɵ3 = ɵ3;
...
var ɵ4 = isInEditedCell;
exports.ɵ4 = ɵ4;
var ɵ5 = cell_context_1.EMPTY_CELL_CONTEXT;
exports.ɵ5 = ɵ5;
/**
...
var GridComponent = /** @class */ (function () {
    function GridComponent(supportService, selectionService, cellSelectionService, wrapper, groupInfoService, groupsService, changeNotification, detailsService, editService, filterService, pdfService, responsiveService, renderer, excelService, ngZone, scrollSyncService, domEvents, columnResizingService, changeDetectorRef, columnReorderService, columnInfoService, navigationService, sortService, scrollRequestService, localization) {
         ...
         */
        this.columnStickyChange = new core_1.EventEmitter();
        /**
        ...
        this.columnStickyChangeSubscription = this.columnInfoService.stickyChange.subscribe(function (changed) {
            _this.columnStickyChange.emit(new column_sticky_change_event_1.ColumnStickyChangeEvent(changed));
        });
    ...
    Object.defineProperty(GridComponent.prototype, "rowSticky", {
         ...
         */
        set: function (fn) {
            if (core_1.isDevMode && utils_1.isPresent(fn) && typeof fn !== 'function') {
                throw new Error("rowSticky must be a function, but received " + JSON.stringify(fn) + ".");
            }
            if (utils_1.isPresent(fn)) {
                this._rowSticky = fn;
            }
        },
        enumerable: true,
    ...
    GridComponent.prototype.ngOnChanges = function (changes) {
        ...
        if (utils_1.isChanged('groupable', changes, true)) {
    ...
    GridComponent.prototype.reorderColumn = function (source, destIndex, options) {
        ...
        var columnsForLevel = column_common_2.sortColumns(this.allColumnsForLevel(source.level));
    ...
    Object.defineProperty(GridComponent.prototype, "isGroupExpanded", {
        ...
        set: function (callback) {
            ...
            this.groupable = utils_1.isPresent(callback);
        },
        enumerable: true,
        configurable: true
    });
    ...
    GridComponent.prototype.reorder = function (_a) {
        ...
        this.ngZone.run(function () {
            var columnsForLevel = column_common_2.sortColumns(_this.allColumnsForLevel(source.level));
    ...
    GridComponent.prototype.updateColumnIndices = function (_a) {
        ...
        var expandedColumns = column_common_1.expandColumnsWithSpan(columnsForLevel);
    ...
    GridComponent.prototype.verifySettings = function () {
        if (core_1.isDevMode()) {
            ...
            if (stickyColumns && column_common_1.expandColumns(this.columnList.toArray()).filter(function (column) { return !column.width && !column_group_component_1.isColumnGroupComponent(column); }).length) {
    ...
    GridComponent.prototype.navigationMetadata = function () {
        ...
        return new navigation_metadata_1.NavigationMetadata(dataRows, headerRows, isVirtual, this.hasPager, utils_1.isPresent(this.detailTemplate), this.wrapper, this.virtualColumns, this.columnsContainer);
    };
    ...
    tslib_1.__decorate([
        core_1.ContentChildren(cell_loading_template_directive_1.CellLoadingTemplateDirective),
        tslib_1.__metadata("design:type", core_1.QueryList)
