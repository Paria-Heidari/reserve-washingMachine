 ...
 * @hidden
 */
var areDatesEqual = function (first, second) {
    first = first || [];
    second = second || [];
    return first.length === second.length && first.every(function (date, index) { return isEqual(date, second[index]); });
};
/**
 * @hidden
 */
var sortDates = function (dates) {
    return dates.filter(function (date) { return isPresent(date); }).sort(function (a, b) { return a.getTime() - b.getTime(); });
};
/**
 * @hidden
 *
...
var HorizontalViewListComponent = /** @class */ (function () {
    ...
    HorizontalViewListComponent.prototype.animateView = function (action) {
        ...
        var start = action === Action.NextView ? 'translateX(0)' : "translateX(-" + (tabRect.width + containerGap) + "px)";
        var end = action === Action.NextView ? "translateX(-" + (tabRect.width + containerGap) + "px)" : 'translateX(0)';
        if (!this.animation) {
...
var ViewComponent = /** @class */ (function () {
    ...
    ViewComponent.prototype.updateData = function () {
        var time = last(this.selectedDates) || getToday();
