...
export declare class MultiSelectTreeComponent implements OnInit, OnDestroy, OnChanges, AfterContentChecked, DataBoundComponent, ExpandableComponent, ControlValueAccessor {
    ...
    private readonly isWrapperActive;
    private readonly isFilterActive;
    private readonly isCheckAllActive;
    /**
     * @hidden
     */
    ...
    constructor(popupService: PopupService, renderer: Renderer2, hostElement: ElementRef, navigationService: NavigationService, _zone: NgZone, localization: LocalizationService, cdr: ChangeDetectorRef, touchEnabled: boolean);
    ngOnInit(): void;
    /**
     * @hidden
     */
