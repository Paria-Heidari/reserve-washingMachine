...
var MultiSelectTreeComponent = /** @class */ (function () {
    ...
    Object.defineProperty(MultiSelectTreeComponent.prototype, "isFilterActive", {
        get: function () {
    ...
    Object.defineProperty(MultiSelectTreeComponent.prototype, "isCheckAllActive", {
        get: function () {
    ...
    MultiSelectTreeComponent.prototype.handleKeydown = function (event) {
        var deleteTag = this.isWrapperActive && event.keyCode === kendo_angular_common_1.Keys.Backspace && this.tags.length > 0;
        if (deleteTag) {
     ...
     * @hidden
     */
    MultiSelectTreeComponent.prototype.toggleCheckAll = function () {
    ...
    tslib_1.__decorate([
        core_1.ViewChild('checkAllInput', { static: false }),
        tslib_1.__metadata("design:type", core_1.ElementRef)
