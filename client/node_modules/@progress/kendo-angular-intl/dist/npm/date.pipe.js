...
DatePipe.ngPipeDef = ɵngcc0.ɵɵdefinePipe({ name: "kendoDate", type: DatePipe, factory: function DatePipe_Factory(t) { return new (t || DatePipe)(ɵngcc0.ɵɵdirectiveInject(intl_service_1.IntlService)); }, pure: true });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DatePipe, [{
        type: Pipe,
        args: [{
                name: 'kendoDate'
            }]
    }], function () { return [{ type: intl_service_1.IntlService }]; }, { intlService: [], transform: [], normalize: [] });
    return DatePipe;
}());
