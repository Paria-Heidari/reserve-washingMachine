...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(IntlService, [{
    ...
    }], function () { return []; }, { changes: [], notify: [] });
    return IntlService;
}());
/**
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CldrIntlService, [{
        type: Injectable
                ...
                type: Inject,
                args: [LOCALE_ID]
            }] }]; }, { localeId: [], localeId: [], format: [], toString: [], formatDate: [], parseDate: [], parseNumber: [], formatNumber: [], dateFieldName: [], dateFormatNames: [], splitDateFormat: [], numberSymbols: [], firstDay: [], weekendRange: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DatePipe, [{
    ...
    }], function () { return [{ type: IntlService }]; }, { intlService: [], transform: [], normalize: [] });
    return DatePipe;
}());
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NumberPipe, [{
    ...
    }], function () { return [{ type: IntlService }]; }, { intlService: [], transform: [] });
    return NumberPipe;
}());
