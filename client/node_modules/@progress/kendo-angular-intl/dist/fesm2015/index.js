...
IntlService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: IntlService, factory: function IntlService_Factory(t) { var r = null; if (t) {
        r = new t();
    }
    else {
        r = cldrServiceFactory(ɵngcc0.ɵɵinject(LOCALE_ID));
    } return r; }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(IntlService, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
    ...
    }], function () { return []; }, { constructor: [], changes: [], notify: [] });;
...
CldrIntlService.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: CldrIntlService, factory: function CldrIntlService_Factory(t) { return new (t || CldrIntlService)(ɵngcc0.ɵɵinject(LOCALE_ID)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CldrIntlService, [{
        type: Injectable
    }], function () { return [{ type: String, decorators: [{
                type: Inject,
                args: [LOCALE_ID]
            }] }]; }, { constructor: [], localeId: [], localeId: [], locale: [], format: [], toString: [], formatDate: [], parseDate: [], parseNumber: [], formatNumber: [], dateFieldName: [], dateFormatNames: [], splitDateFormat: [], numberSymbols: [], firstDay: [], weekendRange: [] });;
...
DatePipe.ngPipeDef = ɵngcc0.ɵɵdefinePipe({ name: "kendoDate", type: DatePipe, factory: function DatePipe_Factory(t) { return new (t || DatePipe)(ɵngcc0.ɵɵdirectiveInject(IntlService)); }, pure: true });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DatePipe, [{
        type: Pipe,
        args: [{
                name: 'kendoDate'
            }]
    }], function () { return [{ type: IntlService }]; }, { constructor: [], intlService: [], transform: [], normalize: [] });;
DatePipe = __decorate([
...
NumberPipe.ngPipeDef = ɵngcc0.ɵɵdefinePipe({ name: "kendoNumber", type: NumberPipe, factory: function NumberPipe_Factory(t) { return new (t || NumberPipe)(ɵngcc0.ɵɵdirectiveInject(IntlService)); }, pure: true });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NumberPipe, [{
        type: Pipe,
        args: [{
                name: 'kendoNumber'
            }]
    }], function () { return [{ type: IntlService }]; }, { constructor: [], intlService: [], transform: [] });;
...
IntlModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: IntlModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(IntlModule, { declarations: [DatePipe,
        NumberPipe], exports: [DatePipe,
        NumberPipe] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(IntlModule, [{
        type: NgModule,
        args: [{
                declarations: [pipes],
                exports: [pipes]
...
IntlModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function IntlModule_Factory(t) { return new (t || IntlModule)(); } });;
