...
const _c1 = [[["label"], ["kendo-label"]], "*", [["kendo-formhint"]], [["kendo-formerror"]]];
const _c2 = ["label, kendo-label", "*", "kendo-formhint", "kendo-formerror"];
...
FormFieldComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: FormFieldComponent, selectors: [["kendo-formfield"]], factory: function FormFieldComponent_Factory(t) { return new (t || FormFieldComponent)(ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(LocalizationService), ɵngcc0.ɵɵdirectiveInject(ElementRef)); }, contentQueries: function FormFieldComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ])], ngContentSelectors: _c2, consts: 5, vars: 3, template: function FormFieldComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef(_c1);
        ɵngcc0.ɵɵprojection(0);
        ɵngcc0.ɵɵelementStart(1, "div");
        ɵngcc0.ɵɵstyling();
        ɵngcc0.ɵɵprojection(2, 1);
        ɵngcc0.ɵɵtemplate(3, FormFieldComponent_3_Template, 1, 0, undefined, _c0);
        ɵngcc0.ɵɵtemplate(4, FormFieldComponent_4_Template, 1, 0, undefined, _c0);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵselect(1);
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FormFieldComponent, [{
    ...
    }], function () { return [{ type: Renderer2 }, { type: LocalizationService }, { type: ElementRef }]; }, { renderer: [], localizationService: [], hostElement: [], hostClass: [{
            type: HostBinding,
        ...
        }], horizontal: [], hasHints: [], hasErrors: [], ngAfterViewInit: [], ngOnDestroy: [], disabledKendoInput: [], disabledControl: [], disabledElement: [], validateFormControl: [], isControlGroup: [], isRadioControl: [], updateDescription: [], findControlElements: [], generateDescriptionIds: [], showHintsInitial: [], showErrorsInitial: [], setDescription: [], direction: [{
            type: HostBinding,
            args: ['attr.dir']
        }], controlElementRefs: [{
            type: ContentChildren,
