...
TextAreaComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: TextAreaComponent, selectors: [["kendo-textarea"]], factory: function TextAreaComponent_Factory(t) { return new (t || TextAreaComponent)(ɵngcc0.ɵɵdirectiveInject(LocalizationService), ɵngcc0.ɵɵdirectiveInject(NgZone), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(Injector), ɵngcc0.ɵɵdirectiveInject(ElementRef)); }, hostBindings: function TextAreaComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
    ...
    } }, inputs: { tabIndex: "tabIndex", focusableId: "focusableId", flow: "flow", rows: "rows", cols: "cols", maxlength: "maxlength", tabindex: "tabindex", resizable: "resizable" }, outputs: { onFocus: "focus", onBlur: "blur", valueChange: "valueChange" }, exportAs: ["kendoTextArea"], features: [ɵngcc0.ɵɵProvidersFeature([
            LocalizationService,
    ...
    } }, directives: [ɵngcc1.NgClass, ɵngcc2.EventsOutsideAngularDirective], encapsulation: 2 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(TextAreaComponent, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: LocalizationService }, { type: NgZone }, { type: ChangeDetectorRef }, { type: Renderer2 }, { type: Injector }, { type: ElementRef }]; }, { flowCol: [{
            type: HostBinding,
            ...
            type: Input
        }], tabIndex: [], ngAfterViewInit: [], ngOnInit: [], control: [], resizeSubscription: [], subscriptions: [], ngOnChanges: [], initialHeight: [], ngAfterViewChecked: [], writeValue: [], value: [], registerOnChange: [], ngChange: [], registerOnTouched: [], ngTouched: [], updateValue: [], ngOnDestroy: [], resizableClass: [], focus: [], focusChangedProgrammatically: [], isFocused: [], blur: [], resize: [], handleBlur: [], setSelection: [], selectAll: [], focusableId: [{
            type: Input
        }], hostClass: [{
            type: HostBinding,
