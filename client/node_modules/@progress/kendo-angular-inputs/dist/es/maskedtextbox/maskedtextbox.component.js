...
const _c0 = ["input"];
const _c1 = ["type", "text", "autocomplete", "off", "autocorrect", "off", "autocapitalize", "off", "spellcheck", "false", 1, "k-textbox", 3, "id", "tabindex", "disabled", "readonly", "kendoEventsOutsideAngular"];
const _c2 = ["input", ""];
const _c3 = function (a0, a1, a2, a3, a4) { return { focus: a0, blur: a1, click: a2, dragstart: a3, drop: a4 }; };
...
MaskedTextBoxComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: MaskedTextBoxComponent, selectors: [["kendo-maskedtextbox"]], factory: function MaskedTextBoxComponent_Factory(t) { return new (t || MaskedTextBoxComponent)(ɵngcc0.ɵɵdirectiveInject(MaskingService), ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(NgZone), ɵngcc0.ɵɵdirectiveInject(Injector), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(RTL, 8)); }, viewQuery: function MaskedTextBoxComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵelement(0, "input", _c1, _c2);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("id", ctx.focusableId)("tabindex", ctx.tabIndex)("disabled", ctx.disabled)("readonly", ctx.readonly)("kendoEventsOutsideAngular", ɵngcc0.ɵɵpureFunction5(6, _c3, ctx.handleFocus, ctx.handleBlur, ctx.handleClick, ctx.handleDragDrop, ctx.handleDragDrop));
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MaskedTextBoxComponent, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [RTL]
            }] }]; }, { service: [], renderer: [], hostElement: [], ngZone: [], injector: [], changeDetector: [], focusableId: [{
            type: Input
        }], disabled: [{
            type: Input
        }], readonly: [{
