...
export declare class TextAreaComponent extends TextFieldsBase implements ControlValueAccessor, AfterViewChecked {
    ...
    private selectAll;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<TextAreaComponent, "kendo-textarea", ["kendoTextArea"], { 'focusableId': "focusableId", 'flow': "flow", 'tabindex': "tabindex", 'resizable': "resizable", 'tabIndex': "tabIndex", 'rows': "rows", 'cols': "cols", 'maxlength': "maxlength" }, { 'onFocus': "focus", 'onBlur': "blur", 'valueChange': "valueChange" }, never>;
}
