...
export declare class FormFieldComponent implements AfterViewInit {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<FormFieldComponent, "kendo-formfield", never, { 'showHints': "showHints", 'orientation': "orientation", 'showErrors': "showErrors" }, {}, ["kendoInput", "formControls", "controlElementRefs", "errorChildren", "hintChildren"]>;
}
