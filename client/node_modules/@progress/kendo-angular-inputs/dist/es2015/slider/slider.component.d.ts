...
export declare class SliderComponent extends SliderBase implements AfterViewInit, ControlValueAccessor, OnChanges, OnDestroy {
    ...
    private handleBlur;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<SliderComponent, "kendo-slider", ["kendoSlider"], { 'focusableId': "focusableId", 'animate': "animate", 'showButtons': "showButtons", 'value': "value", 'tabIndex': "tabIndex", 'dragHandleTitle': "dragHandleTitle", 'incrementTitle': "incrementTitle", 'decrementTitle': "decrementTitle" }, {}, never>;
}
