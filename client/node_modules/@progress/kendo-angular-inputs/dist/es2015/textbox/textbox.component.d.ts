...
export declare class TextBoxComponent implements ControlValueAccessor {
    ...
    private isFocused;
    private handleBlur;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<TextBoxComponent, "kendo-textbox", ["kendoTextBox"], { 'focusableId': "focusableId", 'title': "title", 'disabled': "disabled", 'readonly': "readonly", 'tabindex': "tabindex", 'value': "value", 'selectOnFocus': "selectOnFocus", 'showSuccessIcon': "showSuccessIcon", 'showErrorIcon': "showErrorIcon", 'clearButton': "clearButton", 'tabIndex': "tabIndex", 'successIcon': "successIcon", 'errorIcon': "errorIcon", 'clearButtonIcon': "clearButtonIcon", 'placeholder': "placeholder", 'maxlength': "maxlength" }, { 'valueChange': "valueChange", 'inputFocus': "inputFocus", 'inputBlur': "inputBlur", 'onFocus': "focus", 'onBlur': "blur" }, ["suffixTemplate", "prefixTemplate"]>;
}
