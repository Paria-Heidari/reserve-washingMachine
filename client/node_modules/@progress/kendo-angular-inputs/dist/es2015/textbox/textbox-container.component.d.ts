...
export declare class TextBoxContainerComponent implements AfterContentInit, OnDestroy {
    ...
    private subscribe;
    private updateState;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<TextBoxContainerComponent, "kendo-textbox-container", never, { 'id': "id", 'floatingLabel': "floatingLabel" }, {}, ["kendoInput", "textarea", "formControl"]>;
}

//# sourceMappingURL=textbox-container.component.d.ts.map