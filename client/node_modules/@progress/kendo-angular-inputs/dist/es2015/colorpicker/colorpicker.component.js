...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_8067778471922495440$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_7 = goog.getMsg("Choose color");
    I18N_6 = MSG_EXTERNAL_8067778471922495440$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_7;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_935472034136733879$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_9 = goog.getMsg("Clear value");
    I18N_8 = MSG_EXTERNAL_935472034136733879$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_9;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_1739045502529621844$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_11 = goog.getMsg("Set hue");
    I18N_10 = MSG_EXTERNAL_1739045502529621844$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_11;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_1818720388700598438$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_13 = goog.getMsg("Set opacity");
    I18N_12 = MSG_EXTERNAL_1818720388700598438$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_13;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_67581802130075115$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_15 = goog.getMsg("HEX Color");
    I18N_14 = MSG_EXTERNAL_67581802130075115$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_15;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_1242921922786989001$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_17 = goog.getMsg("Red");
    I18N_16 = MSG_EXTERNAL_1242921922786989001$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_17;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_564969508273982379$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_19 = goog.getMsg("Green");
    I18N_18 = MSG_EXTERNAL_564969508273982379$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_19;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_2815824305218491249$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_21 = goog.getMsg("Blue");
    I18N_20 = MSG_EXTERNAL_2815824305218491249$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_21;
}
else {
...
if (ngI18nClosureMode) {
     ...
     */ 
    const MSG_EXTERNAL_7522085117867122625$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_23 = goog.getMsg("Alpha");
    I18N_22 = MSG_EXTERNAL_7522085117867122625$$DIST_ES2015_COLORPICKER_COLORPICKER_COMPONENT_JS_23;
}
else {
...
function ColorPickerComponent_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyling();
    ɵngcc0.ɵɵlistener("click", function ColorPickerComponent_span_4_Template_span_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r235); const ctx_r234 = ɵngcc0.ɵɵnextContext(); return ctx_r234.handleActiveColorClick(); });
    ɵngcc0.ɵɵtemplate(1, ColorPickerComponent_span_4_span_1_Template, 1, 0, "span", _c34);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r228 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("background-color", ctx_r228.value);
    ɵngcc0.ɵɵstylingApply();
    ɵngcc0.ɵɵselect(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r228.value);
} }
...
function ColorPickerComponent_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ColorPickerComponent_span_5_Template_span_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r237); const ctx_r236 = ɵngcc0.ɵɵnextContext(); return ctx_r236.handleActiveColorClick(); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r229.iconStyles);
    ɵngcc0.ɵɵselect(1);
    ɵngcc0.ɵɵstyleProp("background-color", ctx_r229.value);
    ɵngcc0.ɵɵstylingApply();
} }
...
function ColorPickerComponent_ng_template_8_kendo_colorgradient_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("focusout", function ColorPickerComponent_ng_template_8_kendo_colorgradient_0_Template_kendo_colorgradient_focusout_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); const ctx_r241 = ɵngcc0.ɵɵnextContext(2); return ctx_r241.handlePopupBlur($event); });
    ɵngcc0.ɵɵlistener("valueChange", function ColorPickerComponent_ng_template_8_kendo_colorgradient_0_Template_kendo_colorgradient_valueChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); const ctx_r243 = ɵngcc0.ɵɵnextContext(2); return ctx_r243.handleValueChange($event, false); });
    ɵngcc0.ɵɵlistener("keydown", function ColorPickerComponent_ng_template_8_kendo_colorgradient_0_Template_kendo_colorgradient_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); const ctx_r244 = ɵngcc0.ɵɵnextContext(2); return ctx_r244.handlePopupKeyDown($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r238 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("value", ctx_r238.value)("format", ctx_r238.format)("opacity", ctx_r238.gradientSettings.opacity)("clearButton", ctx_r238.gradientSettings.clearButton)("delay", ctx_r238.gradientSettings.delay);
} }
...
function ColorPickerComponent_ng_template_8_kendo_colorpalette_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("blur", function ColorPickerComponent_ng_template_8_kendo_colorpalette_1_Template_kendo_colorpalette_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r247); const ctx_r246 = ɵngcc0.ɵɵnextContext(2); return ctx_r246.handlePopupBlur($event); });
    ɵngcc0.ɵɵlistener("cellSelection", function ColorPickerComponent_ng_template_8_kendo_colorpalette_1_Template_kendo_colorpalette_cellSelection_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r247); const ctx_r248 = ɵngcc0.ɵɵnextContext(2); return ctx_r248.handleValueChange($event, true); });
    ɵngcc0.ɵɵlistener("mousedown", function ColorPickerComponent_ng_template_8_kendo_colorpalette_1_Template_kendo_colorpalette_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r247); return $event.preventDefault(); });
    ɵngcc0.ɵɵlistener("keydown", function ColorPickerComponent_ng_template_8_kendo_colorpalette_1_Template_kendo_colorpalette_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r247); const ctx_r250 = ɵngcc0.ɵɵnextContext(2); return ctx_r250.handlePopupKeyDown($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r239 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("palette", ctx_r239.paletteSettings.palette)("columns", ctx_r239.paletteSettings.columns)("tileSize", ctx_r239.paletteSettings.tileSize)("format", ctx_r239.format)("value", ctx_r239.value);
} }
function ColorPickerComponent_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", ctx_r231.view === "gradient" || ctx_r231.view === "combo");
    ɵngcc0.ɵɵselect(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r231.view === "palette" || ctx_r231.view === "combo");
} }
