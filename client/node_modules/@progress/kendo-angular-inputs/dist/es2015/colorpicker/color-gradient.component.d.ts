...
export declare class ColorGradientComponent implements OnChanges, OnDestroy, ControlValueAccessor {
     ...
     * @hidden
     */
    readonly colorGradientHandleTitle: string;
    /**
     * @hidden
     */
    readonly colorGradientHandleAriaLabel: string;
    /**
     * @hidden
     */
    readonly hueSliderTitle: string;
    /**
     * @hidden
     */
    readonly opacitySliderTitle: string;
    /**
     * @hidden
     */
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<ColorGradientComponent, "kendo-colorgradient", never, { 'id': "id", 'opacity': "opacity", 'disabled': "disabled", 'readonly': "readonly", 'clearButton': "clearButton", 'delay': "delay", 'format': "format", 'value': "value", 'tabindex': "tabindex", 'contrastTool': "contrastTool" }, { 'valueChange': "valueChange" }, never>;
}

//# sourceMappingURL=color-gradient.component.d.ts.map