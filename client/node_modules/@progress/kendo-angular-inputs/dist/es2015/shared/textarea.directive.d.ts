...
export declare class TextAreaDirective implements OnInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    private handleFocus;
    private handleBlur;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<TextAreaDirective, "textarea[kendoTextArea]", never, { 'autoSize': "autoSize", 'value': "value" }, { 'valueChange': "valueChange" }, never>;
}

//# sourceMappingURL=textarea.directive.d.ts.map