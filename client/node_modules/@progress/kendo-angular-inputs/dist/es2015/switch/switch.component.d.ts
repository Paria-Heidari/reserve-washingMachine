...
export declare class SwitchComponent implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<SwitchComponent, "kendo-switch", ["kendoSwitch"], { 'focusableId': "focusableId", 'disabled': "disabled", 'readonly': "readonly", 'tabindex': "tabindex", 'checked': "checked", 'tabIndex': "tabIndex", 'onLabel': "onLabel", 'offLabel': "offLabel" }, { 'onFocus': "focus", 'onBlur': "blur", 'valueChange': "valueChange" }, never>;
}
