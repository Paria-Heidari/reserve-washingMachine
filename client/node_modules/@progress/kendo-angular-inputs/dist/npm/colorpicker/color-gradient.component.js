...
var ColorGradientComponent = /** @class */ (function () {
    ...
    ColorGradientComponent.prototype.ngOnChanges = function (changes) {
        ...
        if (kendo_angular_common_1.isChanged('delay', changes)) {
    ...
    ColorGradientComponent.prototype.moveDragHandle = function (positionX, positionY) {
        var top = utils_2.fitIntoBounds(positionY, 0, this.gradientRect.height);
        var left = utils_2.fitIntoBounds(positionX, 0, this.gradientRect.width);
        this.setDragHandleElementPosition(top, left);
        this.hsva.s = left / this.gradientRect.width;
        this.hsva.v = 1 - top / this.gradientRect.height;
        this.updateValues.next(utils_1.getColorFromHSV(this.hsva));
    ...
    ColorGradientComponent.prototype.subscribeChanges = function () {
        var _this = this;
        this.changeRequestsSubscription = this.updateValues.pipe(operators_1.throttleTime(this.delay)).subscribe(function (value) {
    ...
    tslib_1.__decorate([
        core_1.ViewChild('inputs', { static: false }),
        tslib_1.__metadata("design:type", color_input_component_1.ColorInputComponent)
    ...
    ColorGradientComponent = ColorGradientComponent_1 = tslib_1.__decorate([
        core_1.Component({
            ...
            providers: [
                ...
                colorgradient_localization_service_1.ColorGradientLocalizationService,
                {
                    provide: kendo_angular_l10n_1.LocalizationService,
                    useExisting: colorgradient_localization_service_1.ColorGradientLocalizationService
                },
                {
